...
class ViewController: UIViewController {
    ...
    private func addExpandingMenu() {
        ...
        menuButton.center = CGPoint(x: self.view.bounds.width - 32.0, y: self.view.bounds.height - 50.0)
...
//        menuItems.forEach{ $0.titleColor = .init(red: 1, green: 1, blue: 1, alpha: 1) }
        menuItems.forEach{ $0.titleColor = #colorLiteral(red: 0.1276455522, green: 0.2034990788, blue: 0.3436715901, alpha: 1) }
